<template>
  <div class="x-component search-select-transport-cause" :style="{width: width}">
    <x-select
      width="100%"
      :source="datas"
      :multiple="multiple"
      :placeholder="label"
      :map="{ value: 'en', label: 'en' }"
      v-model="vmodel"
      :clearable="clearable"
...
export default {
  ...
  methods: {
    ...
    async getDatas () {
      this.preDatas = this.$constant('transportClause')
